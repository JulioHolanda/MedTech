...
int main(void) {
  ...
  int hor, min;
  float intervalo;
  int ms=30;//30 é o valor equivalente a 1 minuto. Para fins de teste mais rápido, este valor pode ser alterado para 1, fazendo o loop rodar de 1 em 1 minuto.
